create or replace function fn_ossa_html
(
    p_css in varchar2
)
return clob
...
<br>
      ...
      <br><br>
<br><br>
As per <a href="https://ocp.oraclecorp.com/ords/gc3pdb001/f?p=102:1:640657796355:::::"> OSSA Compliance Portal (OCP) </a>, you are assigned as CSS for below PA(s). <br>
You are required to complete the pending attestations at the earliest. Please work with the respective project manager(s) and complete the pending attestations ASAP<br>
...
for i in 
(
select css_1,PA_NUMBER,CUSTOMER_NAME,PROJECT_TITLE,OSSA_STATUS,ATTESTATION_STATUS,PROJECT_MANAGER,CSL,
